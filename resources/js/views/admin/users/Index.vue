                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 col-lg-6">
                        <div class="form-group d-flex">
                            <input type="text" v-model="search" @keyup="searchFor" class="form-control" placeholder="Search" />
                        </div>
                        <HasError :form="form" field="search" />
   ...
   mounted(){
    ...
    methods:{
        ...
        searchFor:_.debounce(function() {
            this.$Progress.start()
            axios.get('/admin/search?q='+this.search)
            .then(res => {
                this.users = res.data
